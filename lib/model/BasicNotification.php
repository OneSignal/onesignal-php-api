...
/**
 * BasicNotification Class Doc Comment
 *
 * @category Class
 * @package  onesignal\client
 * @author   OpenAPI Generator team
 ...
 */
class BasicNotification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BasicNotification';
    ...
    public function setEmailBcc($email_bcc)
    {
        ...
        if (!is_null($email_bcc) && (count($email_bcc) > 5)) {
            throw new \InvalidArgumentException('invalid value for $email_bcc when calling BasicNotification., number of items must be less than or equal to 5.');
        }
