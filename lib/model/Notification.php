...
class Notification implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setEmailBcc($email_bcc)
    {
        ...
        if (!is_null($email_bcc) && (count($email_bcc) > 5)) {
            throw new \InvalidArgumentException('invalid value for $email_bcc when calling Notification., number of items must be less than or equal to 5.');
        }
