...
class Purchase implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets sku
     *
     * @param string $sku The unique identifier of the purchased item.
     *
     * @return self
     */
     ...
     * Sets amount
     *
     * @param string $amount The amount, in USD, spent purchasing the item.
     *
     * @return self
     */
     ...
     * Sets iso
     *
     * @param string $iso The 3-letter ISO 4217 currency code. Required for correct storage and conversion of amount.
     *
     * @return self
     */
