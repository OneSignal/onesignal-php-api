...
/**
 * DeliveryData Class Doc Comment
 *
 * @category Class
 * @package  onesignal\client
 * @author   OpenAPI Generator team
 ...
 */
class DeliveryData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DeliveryData';
     ...
     * Sets successful
     *
     * @param int|null $successful Number of messages delivered to push servers, mobile carriers, or email service providers.
     *
     * @return self
     */
     ...
     * Sets failed
     *
     * @param int|null $failed Number of messages sent to unsubscribed devices.
     *
     * @return self
     */
     ...
     * Sets errored
     *
     * @param int|null $errored Number of errors reported.
     *
     * @return self
     */
     ...
     * Sets converted
     *
     * @param int|null $converted Number of messages that were clicked.
     *
     * @return self
     */
     ...
     * Sets received
     *
     * @param int|null $received Number of devices that received the message.
     *
     * @return self
     */
