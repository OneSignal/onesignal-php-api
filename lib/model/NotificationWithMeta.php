...
/**
 * NotificationWithMeta Class Doc Comment
 *
 * @category Class
 * @package  onesignal\client
 * @author   OpenAPI Generator team
 ...
 */
class NotificationWithMeta implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NotificationWithMeta';
    ...
    protected static $openAPITypes = [
        ...
        'web_buttons' => '\onesignal\client\model\WebButton[]',
        'ios_category' => 'string',
        ...
        'converted' => 'int',
        'received' => 'int',
        'outcomes' => '\onesignal\client\model\OutcomeData[]',
        'remaining' => 'int',
        'queued_at' => 'int',
        'send_after' => 'int',
        'completed_at' => 'int',
    ...
    protected static $setters = [
        ...
        'ios_interruption_level' => 'setIosInterruptionLevel',
    ...
    protected static $getters = [
        ...
        'ios_interruption_level' => 'getIosInterruptionLevel',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['ios_interruption_level'] = $data['ios_interruption_level'] ?? null;
        ...
        $this->container['outcomes'] = $data['outcomes'] ?? null;
     ...
     *
     * @param string[]|null $include_subscription_ids Specific subscription ids to send your notification to. _Does not require API Auth Key._ Not compatible with any other targeting parameters. Example: [\"1dd608f2-c6a1-11e3-851d-000c2940e62c\"] Limit of 2,000 entries per REST API call
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $include_ios_tokens Not Recommended: Please consider using include_subscription_ids or include_aliases instead. Target using iOS device tokens. Warning: Only works with Production tokens. All non-alphanumeric characters must be removed from each token. If a token does not correspond to an existing user, a new user will be created. Example: ce777617da7f548fe7a9ab6febb56cf39fba6d38203... Limit of 2,000 entries per REST API call
     *
     * @return self
     */
     ...
     *
     * @param string[]|null $include_chrome_web_reg_ids Not Recommended: Please consider using include_subscription_ids or include_aliases instead. Target using Chrome Web Push registration IDs. If a token does not correspond to an existing user, a new user will be created. Example: APA91bEeiUeSukAAUdnw3O2RB45FWlSpgJ7Ji_... Limit of 2,000 entries per REST API call
     *
     * @return self
     */
     ...
     * Sets app_id
     *
     * @param string $app_id Required: Your OneSignal Application ID, which can be found in Keys & IDs. It is a UUID and looks similar to 8250eaf6-1a58-489e-b136-7c74a864b434.
     *
     * @return self
     */
     ...
     * Sets external_id
     *
     * @param string|null $external_id [DEPRECATED] Correlation and idempotency key. A request received with this parameter will first look for another notification with the same external_id. If one exists, a notification will not be sent, and result of the previous operation will instead be returned. Therefore, if you plan on using this feature, it's important to use a good source of randomness to generate the UUID passed here. This key is only idempotent for 30 days. After 30 days, the notification could be removed from our system and a notification with the same external_id will be sent again.   See Idempotent Notification Requests for more details writeOnly: true
     *
     * @return self
     * @deprecated
     */
     ...
     * Sets contents
     *
     * @param LanguageStringMap|null $contents contents
     *
     * @return self
     */
     ...
     * Sets headings
     *
     * @param LanguageStringMap|null $headings headings
     *
     * @return self
     */
     ...
     * Sets subtitle
     *
     * @param LanguageStringMap|null $subtitle subtitle
     *
     * @return self
     */
     ...
     * Gets web_buttons
     *
     * @return \onesignal\client\model\WebButton[]|null
     */
     ...
     * Sets web_buttons
     *
     * @param \onesignal\client\model\WebButton[]|null $web_buttons Channel: Push Notifications Platform: Chrome 48+ Add action buttons to the notification. The id field is required. Example: [{\"id\": \"like-button\", \"text\": \"Like\", \"icon\": \"http://i.imgur.com/N8SN8ZS.png\", \"url\": \"https://yoursite.com\"}, {\"id\": \"read-more-button\", \"text\": \"Read more\", \"icon\": \"http://i.imgur.com/MIxJp1L.png\", \"url\": \"https://yoursite.com\"}]
     *
     * @return self
     */
     ...
     *
     * @param float|null $ios_relevance_score Channel: Push Notifications Platform: iOS 15+ A score to be set per notification to indicate how it should be displayed when grouped. Use a float between 0-1.
     *
     * @return self
     */
    ...
    /**
     * Gets ios_interruption_level
     *
     * @return string|null
     */
    public function getIosInterruptionLevel()
    {
        return $this->container['ios_interruption_level'];
    }

    /**
     * Sets ios_interruption_level
     *
     * @param string|null $ios_interruption_level Channel: Push Notifications Platform: iOS 15+ Focus Modes and Interruption Levels indicate the priority and delivery timing of a notification, to \"interrupt\" the user. Can choose from options: ['active', 'passive', 'time_sensitive', 'critical']. Default is active.
     *
     * @return self
     */
    public function setIosInterruptionLevel($ios_interruption_level)
    {
        $this->container['ios_interruption_level'] = $ios_interruption_level;
    ...
    /**
     * Gets disable_email_click_tracking
     *
     * @return bool|null
     */
    public function getDisableEmailClickTracking()
    {
        return $this->container['disable_email_click_tracking'];
    }

    /**
     * Sets disable_email_click_tracking
     *
     * @param bool|null $disable_email_click_tracking Channel: Email Default is `false`. If set to `true`, the URLs sent within the email will not include link tracking and will be the same as originally set; otherwise, all the URLs in the email will be tracked.
     *
     * @return self
     */
    public function setDisableEmailClickTracking($disable_email_click_tracking)
    {
        $this->container['disable_email_click_tracking'] = $disable_email_click_tracking;
     ...
     * Gets outcomes
     *
     * @return \onesignal\client\model\OutcomeData[]|null
     */
     ...
     * Sets outcomes
     *
     * @param \onesignal\client\model\OutcomeData[]|null $outcomes outcomes
     *
     * @return self
     */
     ...
     * Sets canceled
     *
     * @param bool|null $canceled Indicates whether the notification was canceled before it could be sent.
     *
     * @return self
     */
