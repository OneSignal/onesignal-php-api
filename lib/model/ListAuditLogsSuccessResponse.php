...
/**
 * ListAuditLogsSuccessResponse Class Doc Comment
 *
 * @category Class
 * @package  onesignal\client
 * @author   OpenAPI Generator team
 ...
 */
class ListAuditLogsSuccessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ListAuditLogsSuccessResponse';
    ...
    protected static $openAPITypes = [
        'audit_logs' => '\onesignal\client\model\AuditLogEvent[]',
        'has_more' => 'bool',
        'next_cursor' => 'string'
    ];
     ...
     * Gets audit_logs
     *
     * @return \onesignal\client\model\AuditLogEvent[]|null
     */
     ...
     * Sets audit_logs
     *
     * @param \onesignal\client\model\AuditLogEvent[]|null $audit_logs Array of audit log events, ordered by occurred_at ascending.
     *
     * @return self
     */
     ...
     * Sets has_more
     *
     * @param bool|null $has_more True if additional events exist beyond this page. Use next_cursor to fetch the next page.
     *
     * @return self
     */
     ...
     * Sets next_cursor
     *
     * @param string|null $next_cursor Opaque cursor to pass as cursor in the next request. Only present when has_more is true.
     *
     * @return self
     */
