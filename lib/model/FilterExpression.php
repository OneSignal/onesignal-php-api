...
class FilterExpression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FilterExpression';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->container['hours_ago'] = $data['hours_ago'] ?? null;
     ...
     * Sets field
     *
     * @param string|null $field Required. Name of the field to use as the first operand in the filter expression.
     *
     * @return self
     */
    ...
    {
        return $this->container['hours_ago'];
    }

    /**
     * Sets hours_ago
     *
     * @param string|null $hours_ago If `field` is session-related, this is *required* to specify the number of hours before or after the user's session.
     *
     * @return self
     */
    public function setHoursAgo($hours_ago)
    {
        $this->container['hours_ago'] = $hours_ago;
     ...
     * Sets radius
     *
     * @param float|null $radius If `field` is `location`, this will specify the radius in meters from a provided location point. Use with `lat` and `long`.
     *
     * @return self
     */
     ...
     * Sets lat
     *
     * @param float|null $lat If `field` is `location`, this is *required* to specify the user's latitude.
     *
     * @return self
     */
     ...
     * Sets long
     *
     * @param float|null $long If `field` is `location`, this is *required* to specify the user's longitude.
     *
     * @return self
     */
     ...
     * Sets relation
     *
     * @param string|null $relation Required. Operator of a filter expression.
     *
     * @return self
     */
