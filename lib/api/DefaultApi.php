...
class DefaultApi
{
    ...
    public function beginLiveActivityRequest($app_id, $activity_id, $begin_live_activity_request)
    {
        ...
        $defaultHeaders['OS-Usage-Data'] = 'kind=sdk, sdk-name=onesignal-php, version=1.0.2';
     ...
     * @throws \onesignal\client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \onesignal\client\model\UpdatePlayerTagsSuccessResponse|\onesignal\client\model\BadRequestError
     */
     ...
     * @throws \onesignal\client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \onesignal\client\model\UpdatePlayerTagsSuccessResponse|\onesignal\client\model\BadRequestError, HTTP status code, HTTP response headers (array of strings)
     */
