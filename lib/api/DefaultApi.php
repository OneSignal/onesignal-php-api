...
class DefaultApi
{
    ...
    public function cancelNotificationRequest($app_id, $notification_id)
    {
        ...
        $defaultHeaders['OS-Usage-Data'] = 'kind=sdk, sdk-name=onesignal-php, version=5.0.0-beta1';
    ...
    public function createAppRequest($app)
    {
        ...
        if (!empty($this->config->getUserAuthKeyToken())) {
            $headers['Authorization'] = 'Key ' . $this->config->getUserAuthKeyToken();
        }
