...
class Configuration
{
     ...
     * @var string
     */
    protected $userAgent = 'OpenAPI-Generator/5.2.1-beta1/PHP';
    ...
    public static function toDebugReport()
    {
        ...
        $report .= '    The version of the OpenAPI document: 5.2.1' . PHP_EOL;
        $report .= '    SDK Package Version: 5.2.1-beta1' . PHP_EOL;
